...
//		List<OrderItem> itemList2=new ArrayList<OrderItem>();
		...
		for (OrderItem orderItem : itemList) {
			...
			Double realPrice = (Double) map.get("price");
//			if(keyword!=null&&keyword.equals("gift")&&orderItem.getPrice()==0){
			if(orderItem.getPrice()==0){
				orderItem.setReal_price(realPrice);
...
//		if(keyword!=null&&keyword.equals("gift")){
//			return itemList2;
//		}
		return itemList;
	}
