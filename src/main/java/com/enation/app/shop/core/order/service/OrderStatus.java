...
public abstract class OrderStatus {
	...
	public static final int PAY_GIFT= 3; //赠品
	public static final int PAY_FREE= 4; //免单
	...
	public static Map<String,Object> getOrderStatusMap(){
		...
		map.put("PAY_GIFT", PAY_GIFT);
		map.put("PAY_FREE", PAY_FREE);
	...
	public static List getPayStatus(){
		...
		map.put(""+OrderStatus.PAY_GIFT, OrderStatus.getPayStatusText(OrderStatus.PAY_GIFT));
		map.put(""+OrderStatus.PAY_FREE, OrderStatus.getPayStatusText(OrderStatus.PAY_FREE));
